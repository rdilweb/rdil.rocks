...
-   [PDF](@site/docs/proposals/lcpy/lcpy_project_proposal.pdf)
-   [RTF (Rich Text Format)](@site/docs/proposals/lcpy/lcpy_project_proposal.rtf)
-   [EPUB](@site/docs/proposals/lcpy/lcpy_project_proposal.epub)
-   [DOCX (Microsoft Word Document)](@site/docs/proposals/lcpy/lcpy_project_proposal.docx)
-   [ODT (OpenDocument Format)](@site/docs/proposals/lcpy/lcpy_project_proposal.odt)
