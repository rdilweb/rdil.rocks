...
<span class="badge badge--success">npm Package</span> <a href="https://npmjs.com/package/static-server-rdil" target="_blank" rel="noopener noreferrer">static-server-rdil</a>
